	...
	const footerLinks = [
		{
			...
			links: [
				...
				{
					name: t("common.docs"),
					path: "https://www.zalithlauncher.cn/docs/projects/zl2",
					external: true,
				},
				{
					name: t("footer.githubOrg"),
					path: "https://github.com/ZalithLauncher",
					external: true,
				},
			],
		},
		{
			...
			links: [
				{
					name: "Discord",
					path: "https://discord.gg/e7C4kytRgK",
					external: true,
				},
				{
					name: t("footer.qqGroup"),
					path: "https://afdian.com/a/MovTery",
					external: true,
				},
				{
					name: t("footer.weblate"),
					path: "https://hosted.weblate.org/projects/zalithlauncher2/",
					external: true,
				},
			],
		},
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
					...
					>
						<div className="flex items-center gap-3">
							...
							/>
							<span className="font-bold text-2xl tracking-tight text-[var(--text-1)]">
								Zalith Launcher
							</span>
						</div>
						...
						<div className="flex gap-4 pt-2">
							...
							<a
								href="https://discord.gg/e7C4kytRgK"
								target="_blank"
								rel="noreferrer"
								className="w-10 h-10 rounded-full bg-[var(--bg-alt)] flex items-center justify-center text-[var(--text-2)] hover:text-[var(--brand)] hover:scale-110 transition-all"
							>
							...
							<a
								href="https://afdian.com/a/MovTery"
								target="_blank"
								rel="noreferrer"
								className="w-10 h-10 rounded-full bg-[var(--bg-alt)] flex items-center justify-center text-[var(--text-2)] hover:text-[var(--brand)] hover:scale-110 transition-all"
							>
					...
					{footerLinks.map((group, groupIndex) => (
						<motion.div
							...
							className="space-y-4"
						>
							<h4 className="font-bold text-[var(--text-1)] uppercase tracking-wider text-sm">
								{group.title}
							</h4>
				...
				>
					<div className="flex flex-col md:flex-row justify-between items-center gap-4">
						<div className="text-sm text-[var(--text-2)] text-center md:text-left">
							<p>
								(c) {currentYear} Zalith Launcher Team.{" "}
							...
							<div className="mt-1 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-1">
								...
								<a
									...
									target="_blank"
									rel="noreferrer"
									className="text-xs opacity-60 hover:opacity-100 hover:text-[var(--brand)] transition-all"
								>
