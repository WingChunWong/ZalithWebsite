					...
					<div className="text-center">
						...
						>
							...
							<a
								...
								target="_blank"
								rel="noreferrer"
								className="px-8 py-3 rounded-full border border-[var(--divider)]/50 hover:bg-[var(--bg-alt)] transition-all flex items-center gap-2 text-lg text-[var(--text-1)] w-full sm:w-auto justify-center"
							>
