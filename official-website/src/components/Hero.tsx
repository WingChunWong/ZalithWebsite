			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				<div className="text-center">
					...
					>
						...
						<a
							href="https://www.zalithlauncher.cn/docs/projects/zl2"
							target="_blank"
							rel="noreferrer"
							className="px-8 py-3 rounded-full border border-[var(--divider)]/50 hover:bg-[var(--bg-alt)] transition-all flex items-center gap-2 text-lg text-[var(--text-1)]"
						>
					...
					>
						<div className="glass-card flex flex-col items-center">
							...
							<h3 className="font-bold text-lg mb-2 text-[var(--text-1)]">
								{t("hero.speed")}
							</h3>
