export default {
	...
	hero: {
		badge: "稳定、高效、纯净",
		title:
			"在 Android 上 <span class='text-[var(--brand)]'>重新定义</span> Java 版体验",
		description:
			"Zalith Launcher 是一款专为 Android 打造的 Minecraft: Java Edition 启动器。它提供了卓越的性能、极简的设计以及全方位的自定义功能。",
		speed: "极速启动",
	...
	privacy: {
		...
		questionDesc:
			"如果您需要进一步了解我们如何处理您的数据，欢迎通过以下方式联系。",
