			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="mb-12">
					...
					<div className="flex items-center gap-4 mb-4">
						...
						<h1 className="text-4xl font-bold text-[var(--text-1)]">
				...
				<div className="mt-12 p-8 rounded-3xl bg-[var(--bg-alt)] border border-[var(--divider)]/20 text-center">
					...
					<div className="flex justify-center gap-4">
						...
						<a
							href="https://github.com/ZalithLauncher/ZalithLauncher2/issues"
							target="_blank"
							rel="noreferrer"
							className="px-8 py-2 rounded-full border border-[var(--divider)]/50 text-[var(--text-1)] hover:bg-[var(--bg)] transition-all text-sm"
						>
