...
export default (<DefaultTheme.Config>{
	...
	nav: [
		...
		},
		{
			...
			items: [
				...
				{
					text: "[EO]edgeone Node-Recommended",
					link: "https://www.zalithlauncher.cn",
				},
			],
		},
	],
	sidebar: [
		...
		},
		{
			...
			items: [
				{
					text: "Download and Install Game",
					link: "/en/docs/help/download_game",
				},
				{ text: "ModLoader", link: "/en/docs/help/modloader" },
				{ text: "Account", link: "/en/docs/help/account" },
				{
					text: "3rd Authentication Servers",
					link: "/en/docs/help/auth_server",
				},
				{
					text: "Replace Skin or Capes",
					link: "/en/docs/help/changing_skin_capes",
				},
		...
		},
		{
			...
			items: [
				...
				{
					text: "Basic Editor Operations",
					link: "/en/docs/control2_help/basic_operation",
				},
				{
					text: "Control Layout Operations",
					link: "/en/docs/control2_help/control_layout_operations",
				},
	...
	domainWarning: {
		title: "Access Notice",
		content:
			"We detected that you are accessing from <strong>{{ currentHostname }}</strong>. For faster website access speed and better stability, we strongly recommend you visit our EdgeOne CDN node:",
		button: "I understand",
